...
public class GrammarpruebaLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"LET", "IF", "WHILE", "FUNCT", "RET", "VAL", "PRINT", "VAR", "COMP", 
			"LOG", "OPNEG", "PI", "PD", "CI", "CD", "IG", "BB", "SUMRES", "MULDIVMOD", 
			"EXP", "COMA", "COMILLA", "NUM", "INT", "FLOAT", "TXT", "POL", "MON", 
			"CHR", "FIN", "NEWLINE", "TAB", "COMMENT", "COMENTARIOLINEA", "COMENTARIOCOMPL", 
			"WS"
		};
	}
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			null, "'let'", "'if'", "'while'", "'function '", "'return'", "'val'", 
