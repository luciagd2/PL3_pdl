...
//Regla de asignación
asign: LET VAR (IG (expr|func|llamFunc))?
    |       VAR IG (expr|func|llamFunc)
    ;
...
func:       FUNCT VAR declVFunc bloq_cod;
if: 	IF PI logico PD bloq_cod;
while:  WHILE PI logico PD bloq_cod;
...
sent: (asign|expr|func|if|while|print|llamFunc) FIN;            //Sentencias de un bloque de codigo
